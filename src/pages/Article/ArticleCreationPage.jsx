...
import "/src/stylesheets/Buttons.css";
...
const ArticleCreationPage = () => {
  ...
  useEffect(() => {
    articleService.getAllArticles().then((articles) => setArticles(articles));
  }, []);
    ...
    articleService
      ...
      .then(() =>
        setArticles((prevArticles) =>
          [...prevArticles].filter(
            (article) => article.article.nom !== articleName
          )
        )
      );
  };
                ...
                <tr key={index}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => deleteArticle(article.article.nom)}
                    >
                      Supprimer
                    </button>
                  </td>
